...
export function DetailsDiv2(){
    return(
        <div id="div2details">
         <p id="header">Match the winning number in the same order to share prizes. Current prizes up for grabs:</p>
         ...
         <div className="match" id="match6">
            <h3>Match first 6</h3>
            <h2><TheCountUp end={904} duration={0.5}/> CAKE</h2>
